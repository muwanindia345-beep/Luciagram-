...
const PostSchema = new mongoose.Schema({ id: String, userId: String, username: String, mediaUrl: { type: String, maxlength: 10000000 }, mediaType: String, caption: String, location: String, tags: [String] }, { timestamps: true });
